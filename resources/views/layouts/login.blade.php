...
<head>
    <meta charset="utf-8" />
    <title>Localkod - Admin Panel</title>
    ...
    <link href="{{ asset('assets/backend/js/lazysizes.min.js') }}" id="app-style" rel="stylesheet" type="text/css" />
                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card overflow-hidden">
                        <div class="bg-primary bg-soft">
                            <div class="row">
                                ...
                                <div class="col-5 align-self-end">
                                    <img src="{{ asset('assets/backend/images/profile-img.png') }}" alt="Localkod-1" class="img-fluid lazyload">
                                </div>
                            </div>
                        </div>
                        <div class="card-body pt-0">
                                ...
                                <a href="https://localkod.com/" target="_blank" class="auth-logo-light">
                                    <div class="avatar-md profile-user-wid mb-4">
                                        <span class="avatar-title cst-login-logo rounded-circle">
                                            <img src="{{ asset('assets/backend/images/favicon.png') }}" alt="" class="img-fluid lazyload" height="34">
                                        </span>
                                    </div>
                                </a>
                            ...
                            <div class="p-2">
                                <form class="form-horizontal" id="login-form" action="{{ route('admin.auth') }}" method="POST">
                                    @csrf
